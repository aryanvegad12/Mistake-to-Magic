...
// Security middleware
app.use(helmet({
  contentSecurityPolicy: false, // Allow React app to load inline scripts
...
app.get('/api/health', (req, res) =>
  res.json({ success: true, message: 'Mistake To Magic API is running 🎯', env: process.env.NODE_ENV })
);
...
if (process.env.NODE_ENV === 'production') {
  ...
  // All non-API routes → serve React index.html (React Router handles them)
  app.get('*', (req, res) => {
