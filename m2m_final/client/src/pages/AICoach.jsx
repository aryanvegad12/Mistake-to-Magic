...
const SUBJECT_TIPS = {
  ...
  Computer: [
    { icon:'💻', action:'Right now', tip:'Re-type the exact code/query you got wrong from scratch — don\'t copy-paste it.' },
    { icon:'🐞', action:'This week',  tip:'Keep a "bug log": write the error message and the one-line fix for every mistake.' },
    { icon:'🔁', action:'Before exam', tip:'Trace through your buggy logic/output questions by hand, line by line, before checking the answer.' },
  ],
  Accountancy: [
